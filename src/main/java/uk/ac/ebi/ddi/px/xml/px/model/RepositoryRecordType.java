...
/**
 * A record in the repository the data was submitted to corresponding to this dataset (for an example PRIDE experiment record).
 * 
    ...
    implements Serializable, PXObject
{
    ...
    public List<RefType> getSourceFileRef() {
        if (sourceFileRef == null) {
            sourceFileRef = new ArrayList<RefType>();
        }
    ...
    public List<RefType> getPublicationRef() {
        if (publicationRef == null) {
            publicationRef = new ArrayList<RefType>();
        }
    ...
    public List<RefType> getInstrumentRef() {
        if (instrumentRef == null) {
            instrumentRef = new ArrayList<RefType>();
        }
